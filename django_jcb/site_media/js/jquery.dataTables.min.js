...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"每页显示 _MENU_ 条记录",sZeroRecords:"找不到相应记录",sEmptyTable:"表中没有可访问的数据",
sLoadingRecords:"正在加载...",sInfo:"显示总量为 _TOTAL_ 条记录中从条 _START_ 条到第 _END_ 条的记录",sInfoEmpty:"记录为空",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sSearch:"按值查询:",sUrl:"",oPaginate:{sFirst:"第一个",sPrevious:"上一个",sNext:"下一个",sLast:"最后一个"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",bRegex:false,
